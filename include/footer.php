        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="footer-links">
                    <li><a href="#" class="text-white"><i class="bi bi-newspaper me-2"></i>Travel</a></li>
                    <li><a href="#" class="text-white"><i class="bi bi-envelope-paper me-2"></i>Darshan</a></li>
                    <li><a href="#" class="text-white"><i class="bi bi-map me-2"></i>Health & Safety</a></li>
                    ...
                    <li><a href="#" class="text-white"><i class="bi bi-cloud-sun me-2"></i>Donate</a></li>
                    <li><a href="#" class="text-white"><i class="bi bi-cloud-sun me-2"></i>Sustainability</a></li>
