            ...
            <div class="row g-5">
                ...
                <div class="col-lg-8 d-flex flex-column">
                    ...
                    <div class="booking-module">
                        ...
                        <ul class="nav nav-tabs" id="transportTabs" role="tablist">
                            <li class="nav-item" role="presentation"><button class="nav-link active" id="bus-tab"
                                    data-bs-toggle="tab" data-bs-target="#bus-panel" type="button" role="tab"><i
                                        class="bi bi-bus-front-fill"></i> <span
                                        id="transport-tab-bus">Bus</span></button></li>
                            <li class="nav-item" role="presentation"><button class="nav-link" id="train-tab"
                                    data-bs-toggle="tab" data-bs-target="#train-panel" type="button" role="tab"><i
                                        class="bi bi-train-front-fill"></i> <span
                                        id="transport-tab-train">Train</span></button></li>
                            <li class="nav-item" role="presentation"><button class="nav-link" id="flight-tab"
                                    data-bs-toggle="tab" data-bs-target="#flight-panel" type="button" role="tab"><i
                                        class="bi bi-airplane-fill"></i> <span
                                        id="transport-tab-flight">Flight</span></button></li>
                        </ul>

                        <div class="tab-content p-4 border border-top-0 rounded-bottom">

                            <!-- Bus Panel -->
                            <div class="tab-pane fade show active" id="bus-panel" role="tabpanel"
                                aria-labelledby="bus-tab">
                                <form class="row g-4">
                                    <div class="col-md-6">
                                        <label for="bus-from" class="form-label" id="form-label-from">From</label>
                                        <input type="text" class="form-control" id="bus-from"
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-light border"
                                                    id="btn-today-bus">Today</button>
                                                <button type="button" class="btn btn-light border"
                                                    id="btn-tomorrow-bus">Tomorrow</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 align-self-end">
                                        <button type="submit" class="btn btn-primary w-100"
                                            id="form-btn-search-buses">Search Buses</button>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="tab-pane fade" id="train-panel" role="tabpanel" aria-labelledby="train-tab">
                                <form class="row g-4">
                                    <div class="col-md-6">
                                        <label for="train-from" class="form-label"
                                            id="form-label-from-train">From</label>
                                        <input type="text" class="form-control" id="train-from"
                                            placeholder="e.g., Delhi">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="train-to" class="form-label" id="form-label-to-train">To</label>
                                        <input type="text" class="form-control" id="train-to" value="Nashik Road (NK)"
                                            disabled>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Date of Journey</label>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="d-flex align-items-center border rounded px-3 py-2 flex-grow-1">
                                                ...
                                                <input type="date" class="form-control d-none"
                                                    id="journey-date-train" />
                                            </div>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-light border"
                                                    id="btn-today-train">Today</button>
                                                <button type="button" class="btn btn-light border"
                                                    id="btn-tomorrow-train">Tomorrow</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 align-self-end">
                                        <button type="submit" class="btn btn-primary w-100"
                                            id="form-btn-search-trains">Search Trains</button>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="tab-pane fade" id="flight-panel" role="tabpanel" aria-labelledby="flight-tab">
                                <form class="row g-4">
                                    <div class="col-md-6">
                                        <label for="flight-from" class="form-label"
                                            id="form-label-from-flight">From</label>
                                        <input type="text" class="form-control" id="flight-from"
                                            placeholder="e.g., Bengaluru">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="flight-to" class="form-label" id="form-label-to-flight">To</label>
                                        <input type="text" class="form-control" id="flight-to" value="Nashik (ISK)"
                                            disabled>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Date of Journey</label>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="d-flex align-items-center border rounded px-3 py-2 flex-grow-1">
                                                ...
                                                <input type="date" class="form-control d-none"
                                                    id="journey-date-flight" />
                                            </div>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-light border"
                                                    id="btn-today-flight">Today</button>
                                                <button type="button" class="btn btn-light border"
                                                    id="btn-tomorrow-flight">Tomorrow</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 align-self-end">
                                        <button type="submit" class="btn btn-primary w-100"
                                            id="form-btn-search-flights">Search Flights</button>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="p-4 border rounded">
                            <form class="row g-4">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-light border dropdown-toggle w-100 text-start"
                                            type="button" id="accommodation-type-dropdown" data-bs-toggle="dropdown"
                                        ...
                                        <ul class="dropdown-menu w-100" aria-labelledby="accommodation-type-dropdown">
                                            <li class="px-3 py-1">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="hotels"
                                                        id="check-hotels" name="accommodation_type[]">
                                                    <label class="form-check-label" for="check-hotels">Hotels</label>
                                                </div>
                                            </li>
                                            <li class="px-3 py-1">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="dharamshalas"
                                                        id="check-dharamshalas" name="accommodation_type[]">
                                                    <label class="form-check-label"
                                                        for="check-dharamshalas">Dharamshalas</label>
                                                </div>
                                            </li>
                                            <li class="px-3 py-1">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="tents"
                                                        id="check-tents" name="accommodation_type[]">
                                                    <label class="form-check-label" for="check-tents">Tents</label>
                                                </div>
                                            </li>
                                            <li class="px-3 py-1">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="homestays"
                                                        id="check-homestays" name="accommodation_type[]">
                                                    <label class="form-check-label"
                                                        for="check-homestays">Homestays</label>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="col-md-6"><label class="form-label"
                                        id="form-label-checkout">Check-out</label>
                                    <input type="date" class="form-control" id="checkout-date">
                                </div>
                                <div class="col-12"><button type="submit" class="btn btn-primary w-100"
                                        id="form-btn-search-stays">Search Stays</button></div>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 d-flex flex-column justify-content-start gap-4">
                    ...
                    <div class="feature-card">
                        ...
                        <p id="shared-travel-desc">Connect with fellow pilgrims on similar routes to share costs and
                            experiences.</p>
