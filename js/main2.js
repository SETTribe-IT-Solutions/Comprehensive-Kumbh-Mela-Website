...
if (document.getElementById('transportTabs')) {
    ...
    // --- ✅ D. Ensure Only Active Tab Panel is Visible ---
    const tabButtons = document.querySelectorAll('#transportTabs button[data-bs-toggle="tab"]');

    tabButtons.forEach(tab => {
        tab.addEventListener('shown.bs.tab', function (event) {
            const targetTabId = event.target.getAttribute('data-bs-target'); // e.g., #train-panel
            ...
            const activePanel = document.querySelector(targetTabId);
            if (activePanel) {
